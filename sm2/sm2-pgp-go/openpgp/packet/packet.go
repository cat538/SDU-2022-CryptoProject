...
package packet // import "openpgp/packet"
...
const (
	...
	PubKeyAlgoSM2 PublicKeyAlgorithm = 15
...
func (pka PublicKeyAlgorithm) CanEncrypt() bool {
	switch pka {
	case PubKeyAlgoRSA, PubKeyAlgoRSAEncryptOnly, PubKeyAlgoElGamal, PubKeyAlgoSM2:
		return true
	}
	return false
}
...
func (cipher CipherFunction) blockSize() int {
	...
	case CipherCAST5:
		return 8
	case CipherAES128, CipherAES192, CipherAES256, CipherSM4:
		return 16
	}
	return 0
}
