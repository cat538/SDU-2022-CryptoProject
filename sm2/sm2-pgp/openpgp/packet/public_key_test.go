...
var pubKeyTests = []struct {
	...
	//{sm2PkDataHex, sm2FingerprintHex, time.Unix(0, 0), PubKeyAlgoECDSA, 0x43fe956c542ca00b, "43FE956C542CA00B", "542CA00B"},
}
...
func TestSM2KeyID(t *testing.T) {
	...
	sm2Pub := &sm2.PublicKey{
		Curve: sm2.P256Sm2(),
		X:     fromHex("09F9DF311E5421A150DD7D161E4BC5C672179FAD1833FC076BB08FF356F35020"),
		Y:     fromHex("CCEA490CE26775A52DC6EA718CC1AA600AED05FBF35E084A6632F6072DA9AD13"),
	}
	pub := NewSM2PublicKey(time.Unix(1297309478, 0), sm2Pub)
	//fmt.Printf("%x", pub.KeyId)

	const want = uint64(0x602c4f4816dea885)
	if pub.KeyId != want {
		t.Errorf("want key ID: %x, got %x", want, pub.KeyId)
	}
}
...
const sm2PkDataHex = "3059301306072a8648ce3d020106082a811ccf5501822d03420004dc73ae455cf8abd0f7f68e5daa8b48f47ddb93eb7e42cb3d932f3203177e9866b3ad10a3742e6aca4770a7cbefd974edbd0a5c985f23e2bd0ef1329b707a2f53"

const sm2FingerprintHex = "3044022079c913255be00bd16bd96a08717dfb022a4122461589bedbe17d90094cfa276702205ea36f2d38896d2918a0fa25c2b0dddc9110dce92b2edb0ef47204d5dd597582"
